<nav class="w-full bg-[#151f11] px-8 py-3 flex items-center justify-center border-b border-[#263a1d]">
  <div class="flex items-center space-x-8">
    ...
    <a href="/logout" class="ml-4 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 transition">
      Déconnexion
    </a>
  </div>
</nav>